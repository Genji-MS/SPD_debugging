...
ACTUAL: False, False
ERROR: No syntax error. Logic Error
LINE: 25 & 26
ISSUE: else: return False
DESCRIPTION: this else statement to return False will trigger after the first attempt and end the program.
FIX: line 25 & 26   [deleted lines]
COMMENT: The program will run correctly
'''